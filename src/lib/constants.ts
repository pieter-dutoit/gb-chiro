...
export const WHAT_TO_EXPECT_STEPS: ExpectStep[] = [
  ...
  },
  {
    ...
    paragraphs: [
      "During the report of findings, we’ll review how you’ve responded to your initial treatment and work together to outline a care plan tailored to your goals. Depending on your specific condition, it may take anywhere from a few sessions to several weeks of treatment to achieve optimal results. We’ll discuss your individual needs during our meeting, making sure you feel informed about the process. Throughout your care, we’ll work together to monitor your progress, and your feedback will help us adjust the plan as needed to ensure you’re always moving in the right direction.",
    ],
  },
  {
    icon: "calender",
